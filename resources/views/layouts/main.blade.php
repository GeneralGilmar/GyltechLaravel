      ...
      <div class="container">
        <div class="row gy-4">
          ...
          <div class="col-lg-2 col-6 footer-links">
            ...
            <ul>
              <li><i class="bi bi-chevron-right"></i> <a href="#">Serviços de redes e Manutenção</a></li>
              <li><i class="bi bi-chevron-right"></i> <a href="#"> Serviços de programação</a></li>
              <li><i class="bi bi-chevron-right"></i> <a href="#">Design</a></li>
              <li><i class="bi bi-chevron-right"></i> <a href="#">IT Outsourcing Services</a></li>
              <li><i class="bi bi-chevron-right"></i> <a href="#">Business intelegence</a></li>
              <li><i class="bi bi-chevron-right"></i> <a href="#">Treinamento de funcionários</a></li>
            </ul>
          </div>
          ...
          <div class="col-lg-3 col-md-12 footer-contact text-center text-md-start">
            ...
            <p>
             Luanda-Rangel<br>
              ...
              Angola <br><br>
              <strong>Telefone:</strong> (+244) 944511777<br>
